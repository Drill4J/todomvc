...
(function (todos) {
    ...
    var TodoCtrl = (function () {
        ...
        TodoCtrl.prototype.oneLiner = function () { alert('covered < 0.1%'); };
        ;
        TodoCtrl.prototype.bloat = function (x) {
            if (x > 1) {
                return;
            }
            console.log('#');
        ...
        ;
        TodoCtrl.prototype.sampleSwitch = function () {
        ...
        TodoCtrl.prototype.sampleIf = function () {
        ...
        TodoCtrl.prototype.sampleIfElse = function () {
        ...
        TodoCtrl.prototype.sampleIfElseIf = function () {
        ...
        TodoCtrl.prototype.sampleFor = function () {
            alert("sample for called " + (this.callCounters.for + 1) + " times");
            var str = '';
            for (var i = 0; i < this.callCounters.for; i++) {
                str += i;
            }
            alert("str: " + str);
            this.callCounters.for++;
        };
        TodoCtrl.prototype.sampleMap = function () {
